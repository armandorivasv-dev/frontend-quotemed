...
import { authRegisterApi } from "@/services/api/auth";
...
const AuthRegister = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formData) => {
      try {
        const response = await authRegisterApi(formData);
        await toast(
          "Usuario creado satisfactorimente, ingrese con usuario y password!!!"
        );
        changeForm();
